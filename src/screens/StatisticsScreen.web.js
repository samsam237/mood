    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Vos progrès des 7 derniers jours</Text>
        </View>
        ...
        <Card style={styles.tipsCard}>
          ...
          <Text style={styles.tipsTitle}>💡 Analyse de vos performances</Text>
          <View style={styles.tipsList}>
            {avgWater < dailyGoals.water && (
              <Text style={styles.tipText}>
                • Augmentez votre hydratation : vous êtes à {Math.round((avgWater/dailyGoals.water)*100)}% de votre objectif
              </Text>
            )}
            {avgWater >= dailyGoals.water && (
              <Text style={[styles.tipText, { color: theme.colors.success }]}>
                ✓ Excellent ! Vous atteignez votre objectif d'hydratation
              </Text>
            )}
            {avgMovements < dailyGoals.movements && (
              <Text style={styles.tipText}>
                • Bougez plus souvent : vous faites {avgMovements} mouvements/jour (objectif: {dailyGoals.movements})
              </Text>
            )}
            {avgMovements >= dailyGoals.movements && (
              <Text style={[styles.tipText, { color: theme.colors.success }]}>
                ✓ Bravo ! Vous êtes actif régulièrement
              </Text>
            )}
            {successRate >= 5 && (
              <Text style={[styles.tipText, { color: theme.colors.success }]}>
                ✓ Superbe régularité ! Continuez comme ça
              </Text>
            )}
          </View>
        </Card>
        ...
        <Card style={styles.impactCard}>
          <View style={styles.impactHeader}>
            ...
            <Text style={styles.impactTitle}>Votre Impact Santé</Text>
          </View>
          ...
          <Text style={styles.impactSubtext}>
            Chaque action compte dans la lutte contre la sédentarité ! 💪
          </Text>
        </Card>
